...
export const getProduct = (params)=>{
	return http.get('http://127.0.0.1:85/admin/news',{params})
}
...
export const apiNews = (params,method)=>{
	// return apiHttp('http://39.105.2.43:90/admin/news',params,method)
	return apiHttp('http://127.0.0.1:85/admin/news',params,method)
}