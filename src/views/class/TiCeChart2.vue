<template>
	<div>
		...
		<div id='gradeChat' style="height: 300px;margin-bottom:50px"></div>
...
<script setup>
	...
	const getTiCeData = ()=>{
		...
		downloadUrl.value = import.meta.env.VITE_API_HOST+'/score/class_test_avg/?'+qs.stringify(planParams.value)
