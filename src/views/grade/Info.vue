		...
		<div class="ty-box">
			...
			<div class="al-flex-between" style="margin-bottom: 20px;">
				...
				<div class="al-flex" style="align-items: center;">
					...
					<el-select v-model="planQuery.gender" class="m-2" style="width: 100px;margin: 0 10px;" placeholder="请选择">
						<el-option label="全部" value="全部" />
						<el-option label="男" value="男" />
						<el-option label="女" value="女" />
					</el-select>
					<p style="color: #222426;">班级</p>
					<el-select v-model="planQuery.class_id" class="m-2" style="width: 100px;margin: 0 10px;" placeholder="请选择">
			...
			<TiCeChart :class-id="gradeId" :grade-id="gradeId" :plan-query="planQuery" :projects="projects"></TiCeChart>
		</div>
	</div>
</template>

<script setup>
	import {getGradeInfo,getGradeTable} from '@/api/base'
